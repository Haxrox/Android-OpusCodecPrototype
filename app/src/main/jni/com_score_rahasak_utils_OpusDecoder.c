...
JNIEXPORT jboolean JNICALL Java_com_example_opustest_utils_OpusDecoder_nativeInitDecoder (JNIEnv *env, jobject obj, jint samplingRate, jint numberOfChannels, jint frameSize)
{
...
JNIEXPORT jint JNICALL Java_com_example_opustest_utils_OpusDecoder_nativeDecodeBytes (JNIEnv *env, jobject obj, jbyteArray in, jshortArray out)
{
...
JNIEXPORT jboolean JNICALL Java_com_example_opustest_utils_OpusDecoder_nativeReleaseDecoder (JNIEnv *env, jobject obj)
{
    free(dec);
